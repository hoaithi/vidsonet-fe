...
//                     console.log('Fetched videos:', videosResponse.data.content);
//                 }
//             } catch (error) {
...
export default function ChannelPage() {
  ...
  const isOwnChannel = isAuthenticated && user && user.id === channelId;
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="videos" className="mt-6">
        ...
        <TabsContent value="posts" className="mt-6">
          <ChannelPostsTab userId={channelId} isOwnChannel={isOwnChannel ?? undefined} />
        </TabsContent>
